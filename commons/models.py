...
class BaseStampedModel(models.Model):
    ...
    created_user = models.ForeignKey(User, blank=True, null=True, related_name = "%(class)s_created_user" )
    ...
    modified_user = models.ForeignKey(User, blank=True, null=True, related_name = "%(class)s_modified_user" )
