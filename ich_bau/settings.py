...
# DEBUG, PROJECT_ROOT, PACKAGE_ROOT, DATABASES, MEDIA_ROOT, MEDIA_URL, STATIC_ROOT, STATIC_URL, SECRET_KEY, ALLOWED_HOSTS, EMAIL_BACKEND, EMAIL_HOST, EMAIL_HOST_USER, EMAIL_HOST_PASSWORD, EMAIL_PORT, EMAIL_USE_TLS
try:
...
WSGI_APPLICATION = "ich_bau.wsgi.application"
